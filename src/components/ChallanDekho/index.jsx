...
const ChallanDekhoComponent = () => {
  return (
    <div>
      <div className="challanDekho-image">
        <img
          className="open-challanDekho-image"
          src="Open Park+ App (1).png"
          alt=""
        ></img>
      </div>
      <div className="open-park-text">
        <h4 className="open-challan-dekho">Open Challan Dekho app</h4>
      </div>
      ...
      <div className="paragraph-challan-status">
        <p>Now, click on the update button to check the e-challan status</p>
      </div>
      <div className="pending-challan-img">
        <img
          className="pending-challan-image"
      ...
      <div className="paragraph-pending-challan">
        <p>Once done, check your challan, and pay the pending fees</p>
      </div>
      <div className="recieve-confirmation-img">
        <img
          className="recieve-confirmation-image"
      ...
      <div className="paragraph-recieve-confirmation">
        <p>
          After a successful transaction, you will receive a confirmation on
...
export default ChallanDekhoComponent;
